...
//  打印日志
//
//  Created by jianfeng on 14/12/7.
//  Copyright (c) 2014年 六阿哥. All rights reserved.
//

#import <UIKit/UIKit.h>
#import "NSObject+NewLog.h"
#import <objc/runtime.h>

@implementation NSObject (NewLog)

+ (void)load {
    // 交换两个方法的实现
    method_exchangeImplementations(class_getInstanceMethod([NSObject class], @selector(description)), class_getInstanceMethod([NSObject class], @selector(jfDescription)));
}
...
@implementation NSDictionary (NewLog)
